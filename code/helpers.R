...
superlearner_train_and_predict <- function(data,
  ...
  if (!is.null(return_fit)) {
    return(c(sl_fit, secondary_predictions))
  } else {
...
off_feats <- tolower(c(
  ...
  "pop_density_dhsyear",
  "dhsyear",
  "pop_all_age_female_dhsyear",
  "pop_all_age_male_dhsyear",
  "subnational_gdi_dhsyear",
  "subnational_hdi_males_dhsyear",
  "subnational_hdi_females_dhsyear",
  "educational_index_females_dhsyear",
  "educational_index_males_dhsyear",
  "income_index_females_dhsyear",
  "income_index_males_dhsyear",
  "internet_speed",
  "continent",
...
off_feats_current <- tolower(c(
  ...
  # "rwi_mean",
  "pop_density_2020",
  "pop_all_age_female_2020",
  "pop_all_age_male_2020",
  "subnational_gdi_2021",
  "subnational_hdi_males_2021",
  "subnational_hdi_females_2021",
  "educational_index_females_2021",
  "educational_index_males_2021",
  "income_index_females_2021",
  "income_index_males_2021", 
  "internet_speed",
  "continent",
  "hdi_national_2022",
  "gdi_national_2022"
