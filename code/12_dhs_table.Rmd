...
countries <- c("angola", "armenia", "benin", "burkina_faso", "burundi", "cambodia", 
               "cameroon", "cote_divoire", "ethiopia", "gabon", "gambia", "guinea", "haiti", "india", 
               "kenya", "liberia", "madagascar", "malawi", "mali", "mauritania", "mozabique", "nepal", 
...
```{r}
master_file_full <- read_csv(here("data", "master_data_file_jan16_with_national.csv"), 
