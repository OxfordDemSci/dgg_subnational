...
rmd_files <- rmd_files[!rmd_files %in% c("00_run_all.Rmd", "01_fit_models_crossvalidation.Rmd",  "02_make_predictions.Rmd", "10_bootstrap_analysis.Rmd", "12_dhs_table.Rmd")] ##  
...
for (cur_file in rmd_files[1:17]) { 
