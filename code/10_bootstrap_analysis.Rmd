...
```{r}
## read in crosswalk 
xwalk <- read_csv("/Users/caseybreen/Library/CloudStorage/Dropbox-NuffieldCollege/Casey Breen/dgg_research/subnational/data_processing/result_gadm1_LMIC/dhs_cluster_gamd1_crosswalk.csv", 
...
bootstrap_results_women <- map_dfr(1:1000, ~internet_usage_women(dhs_surveys_wom, "women"), .id = "iteration", .progress = T)
bootstrap_results_men <- map_dfr(1:1000, ~internet_usage_men(dhs_surveys_men, "men"), .id = "iteration",  .progress = T)
...
bootstrap_women <- map_dfr(1:1000, ~bootstrap_iteration_mobile_wom(dhs_surveys_wom, "women"), .id = "iteration", .progress = T)
bootstrap_men <- map_dfr(1:1000, ~bootstrap_iteration_mobile_men(dhs_surveys_men, "men"), .id = "iteration", .progress = T)
