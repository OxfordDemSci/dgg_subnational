...
```{r}
predictions_old <- read_csv(here("out", "combined_predictions_lmics_national_covars_full.csv"))

## read predictions
predictions_combined <- read_csv(here("out", "combined_predictions_lmics_national_covars_full_test.csv")) %>%
  filter(country != "Lesotho" & country != "Swaziland") %>% # & country != "Gambia" 
...
gadm1 <- read_csv(here("data", "master_data_file_jan16_with_national.csv"),
...
predictions_combined <- predictions_combined %>%
  left_join(gadm1 %>% 
              mutate(country = case_when(
                country == "CÃ´te d'Ivoire" ~ "Côte d'Ivoire", TRUE ~ country)), by = c("gid_1", "country", "year" = "dhsyear")) 
...
## save plots
ggsave(plot = observed_predicted_plot_country_mobile_wom, filename = here("figures", "observed_predicted_plot_country_mobile_wom.png"), width = 10, height = 8)
ggsave(plot = observed_predicted_plot_country_mobile_men, filename = here("figures", "observed_predicted_plot_country_mobile_men.png"), width = 10, height = 8)
ggsave(plot = observed_predicted_plot_country_mobile_fm_ratio, filename = here("figures", "observed_predicted_plot_country_mobile_fm_ratio.png"), width = 10, height = 8)
```
...
## save plots
ggsave(plot = observed_predicted_plot_country_internet_wom, filename = here("figures", "observed_predicted_plot_country_internet_wom.png"), width = 10, height = 8)
ggsave(plot = observed_predicted_plot_country_internet_men, filename = here("figures", "observed_predicted_plot_country_internet_men.png"), width = 10, height = 8)
ggsave(plot = observed_predicted_plot_country_internet_fm_ratio, filename = here("figures", "observed_predicted_plot_country_internet_fm_ratio.png"), width = 10, height = 8)
```
