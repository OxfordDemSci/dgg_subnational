...
var_importance_data <- cv_results %>%
  ...
  mutate(feature_recode = case_when(
    feature == "fb_pntr_18p_female" ~ "Facebook Penetration (Female)",
    feature == "fb_pntr_18p_male" ~ "Facebook Penetration (Male)",
    grepl("all_devices_age_18_plus_gg", feature) ~ "Facebook Penetration Gender Gap",
    grepl("fb_pntr_18p_male_national", feature) ~ "Facebook Penetration National (Male)",
    grepl("fb_pntr_18p_female_national", feature) ~ "Facebook Penetration National (Female)",
    ...
    grepl("ios_age_18_plus_female_frac_2021", feature) ~ "iOS FB Usage (Female)",
    ...
    grepl("wifi_age_18_plus_female_frac_2024_tess", feature) ~ "WiFi FB Usage (Female)",
    grepl("wifi_age_18_plus_male_frac_2024_tess", feature) ~ "WiFi FB Usage (Male)",
    grepl("hdi", feature) ~ "Human Development Index (National)",
    feature == "gdi" ~ "Gender Development Index (National)",
    feature == "subnational_gdi" ~ "Gender Development Index",
    grepl("ios_age_18_plus_male_frac_2021", feature) ~ "iOS FB Usage (Male)",
    grepl("income_index_females", feature) ~ "Income Index (Female)",
    grepl("pop_density", feature) ~ "Population Density",
    grepl("wifi_age_18_plus_male_frac_2021", feature) ~ "WiFi FB Usage (Male)",
    grepl("wifi_age_18_plus_female_frac_2021", feature) ~ "WiFi FB Usage (Female)",
    feature == "dhsyear" ~ "DHS Survey Year",
    feature == "x4g_age_18_plus_female_frac_2024" ~ "4G+ Network FB Usage", 
    grepl("all_devices_age_18_dhsyear_gg_national", feature) ~ "Facebook National Gender Gap",
    grepl("all_devices_age_18_plus_gg_2021_impute", feature) ~ "Facebook Gender Gap",
