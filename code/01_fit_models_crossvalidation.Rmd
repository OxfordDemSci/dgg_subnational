...
master_file <- master_file %>% 
  mutate(fb_pntr_18p_female = case_when(
    fb_pntr_18p_female > 1.1 ~ 1.1,
    TRUE ~ fb_pntr_18p_female
  )) %>% 
  mutate(fb_pntr_18p_male = case_when(
    fb_pntr_18p_male > 1.1 ~ 1.1,
    TRUE ~ fb_pntr_18p_male
  ))
